export default function Footer() {
  return (
    <footer className="w-full border-t border-white/10 py-24">
      <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-3 gap-10">

        {/* Newsletter */}
        <div className="lg:col-span-1 rounded-3xl overflow-hidden relative">
          <img
        ...
        <div className="lg:col-span-2 grid grid-cols-1 gap-10">
          ...
          {/* Brand card */}
          <div className="rounded-3xl bg-[#0b0b0b] p-10 flex flex-col gap-6">
          ...
          {/* Links */}
          <div className="rounded-3xl bg-[#0b0b0b] p-10">
            <h4 className="text-lg font-medium mb-6">Template pages</h4>

            <div className="grid grid-cols-2 md:grid-cols-4 gap-y-4 text-sm text-white/70">
