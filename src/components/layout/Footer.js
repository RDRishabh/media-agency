          ...
          <div className="rounded-3xl bg-[#0b0b0b] p-6 sm:p-8 md:p-10 flex flex-col gap-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <div className="flex items-center gap-5 text-white/70">
                <a href="https://www.instagram.com/letemknow.media/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">
                ...
                <a href="https://www.linkedin.com/company/let-em-know/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">
          ...
          <div className="rounded-3xl bg-[#0b0b0b] p-6 sm:p-8 md:p-10">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <div className="flex flex-col gap-3 text-sm text-white/70">
                  <a href="mailto:hello@letemknow.media" className="hover:text-white transition">hello@letemknow.media</a>
                  <a href="tel:+918588812345" className="hover:text-white transition">+91 85888 12345</a>
                  <a href="tel:+919560823299" className="hover:text-white transition">+91 95608 23299</a>
